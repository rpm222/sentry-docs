...
title: Add Context
sidebar_order: 1
notSupported:https://twitter.com/mmmmoohm?s=11
  - native.breakpad
  - native.crashpad
  - native.minidumps
  - native.ue4
...
</markdown></Note>https://twitter.com/mmmmoohm?s=11
...
});https://twitter.com/mmmmoohm?s=11
```
...
```javascript
Sentry.setUser(someUser);https://twitter.com/mmmmoohm?s=11
```
